 ...
 <div class="w-full text-white bg-main-color">
        <div x-data="{ open: false }"
            ...
            <div class="p-4 flex flex-row items-center justify-between">
                <a href="#"
                    class="text-lg font-semibold tracking-widest uppercase rounded-lg focus:outline-none focus:shadow-outline">Student
                    View</a>
        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-green-400">
                    ...
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{$eleve->nom}}</h1>
                    ...
                    <div class="text-gray-700">
                        <div class="grid md:grid-cols-2 text-sm">
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">{{$eleve->nom}}</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Last Name</div>
                                <div class="px-4 py-2">{{$eleve->prenom}}</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Student Id</div>
                                <div class="px-4 py-2">{{$eleve->id}}</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Club Id</div>
                                <div class="px-4 py-2">{{$eleve->club_id}}</div>
                            </div>
                            <div class="grid grid-cols-2">
