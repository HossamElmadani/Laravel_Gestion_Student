...
<a class='float-right border border-slate-400 m-5 rounded-md bg-yellow-100 p-2 mt-7 transition duration-200 hover:bg-yellow-300 ease' href="{{route('eleves.create')}}">Add student</a>
      ...
      <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4">
          ...
          >
            ...
            <a class="navbar-brand" href="{{ route('eleves.show', $el->id) }}">Student View</a>
          </span>
        </td>
        ...
        <td class="px-6 py-4">
          <div class="flex justify-end gap-4">
            ...
            <a href="{{route('eleves.edit',$el->id)}}" x-data="{ tooltip: 'Edite' }">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
